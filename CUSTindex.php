...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link href="customerpages/index/css/animate.css" rel="stylesheet">
  <link rel="stylesheet" href="customerpages/index/css/bootstrap.min.css" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Lato:300,400,700" rel="stylesheet">
  <link rel="stylesheet" href="customerpages/index/css/style.css">
...
<div class="container-fluid fh5co-network">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h4 class="wow bounceInUp">ABOUT US</h4>
        <h2 class="wow bounceInRight">GURNEY BOWL BOOKING SYSTEM</h2>
        <hr />
        
        <p class="wow bounceInDown">Gurney Bowl is a top bowling alley located in Kuala Lumpur's Gurney Mall, Residensi UTMKL. We provide a fun environment with state-of-the-art facilities, affordable rates for UTM students and staff, and a welcoming atmosphere for everyone. Enjoy a memorable bowling experience with us.</p>
      </div>
      <div class="col-md-6">
        <figure class="wow bounceInDown"> <img src="customerpages/index/images/about.png" alt="gym" class="img-fluid" /> </figure>
      </div>
    </div>
  </div>
</div>
<div id="about-us" class="container-fluid fh5co-about-us pl-0 pr-0 parallax-window" data-parallax="scroll" data-image-src="customerpages/index/images/bg3.png">
  <div class="container">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body mb-4 wow bounceInLeft" data-wow-delay=".25s">
            <h4 class="card-title"><b>BOWLING</b></h4>
            <p class="card-text">Experience the thrill of bowling in a vibrant and welcoming atmosphere, perfect for all skill levels.</p>
          </div>
          <img class="card-img-top img-fluid wow bounceInRight" data-wow-delay=".25s" src="customerpages/index/images/SERVbowling.png" alt="Card image"> </div>
      </div>
      <div class="col-md-4">
        <div class="card"> <img class="card-img-top img-fluid wow bounceInUp" data-wow-delay=".25s" src="customerpages/index/images/bizhour.png" alt="Card image">
          <div class="card-body mt-4 wow bounceInDown" data-wow-delay=".25s">
            <h4 class="card-title"><b>BUSINESS HOURS</b></h4>
            <p class="card-text">We are open every day from 9:00 AM to 11:00 PM. Drop by anytime for an unforgettable experience.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          <div class="card-body mb-4 wow bounceInRight" data-wow-delay=".25s">
            <h4 class="card-title"><b>SNOOKER</b></h4>
            <p class="card-text">Relax and play in our premium snooker room, designed for both casual and competitive players.</p>
          </div>
          <img class="card-img-top img-fluid wow bounceInLeft" data-wow-delay=".25s" src="customerpages/index/images/snooker.png" alt="Card image"> </div>
      </div>
    </div>
  </div>
</div>
