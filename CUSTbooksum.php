                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="userheader">
                        <form action="php/bookfunc.php" 
                            method="post">
                       <h6 class="mb-2 text-primary" style="text-align: center;">BOOK SUMMARY<hr></h6>
                   </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                       <i class="fa fa-calendar"></i>
                        ...
                        <div class="DOB">
                            <p type="date" class="form-control" name="dp"><?=$user['play_date']?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                       <i class="fa fa-user"></i>
                        ...
                        <p type="number" class="form-control" name="pax"><?=$user['pax_player']?></p>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    ...
                    <label for="website">Preferred Time</label>
                        <div class="timeradio">
                           <div class="form-group">
                            <label class="time">
                                <p type="text" class="form-control" name="time"><?=$user['Time']?></p>
                            </label>
                        </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                       <i class="fas fa-shoe-prints"></i>
                        ...
                        <p type="number" class="form-control" name="bowlshoes"><?=$user['bowl_shoes']?></p>
                    </div>

                      <div class="form-group">
                       <i class="fa fa-bowling-ball"></i>
                        <label for="number">Number of Lane</label>
                        <p type="number" class="form-control" name="num_lane"><?=$user['num_lane']?></p>
                    </div>
                    
                    <div class="form-group">
                    <i class="fa fa-envelope"></i>
                        <label for="eMail">Email Address</label>
                        <p type="email" class="form-control" id="eMail" placeholder="Email address"
                        name="Email"><?=$user['email']?></p>
                    </div>
                </div>
                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-right">
                            <a href="CUSTviewprofile.php"><button type="button" id="submit" name="submit" class="btn btn-primary">Home</button></a>
                        </div>
                    </div>
                </div>
                </form>
...
<?php }else { 
     header("Location: CUSTbooksum.php");
     exit;
    } ?>
