...
<body>
<div class="container-fluid pl-0 pr-0 bg-img clearfix parallax-window2" data-parallax="scroll" data-image-src="images/bghome1.jpg">
  <nav class="navbar navbar-expand-md navbar-dark">
    <div class="container"> 
      <!-- Brand --> 
      <a class="navbar-brand mr-auto" href="index.html"><img src="images/gbbslogo.png" alt="GBBS" width="100px" height="100px"/></a>
...
<div class="container-fluid fh5co-network">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        <figure class="wow bounceInDown"> <img src="images/about.png" alt="gym" class="img-fluid" /> </figure>
      </div>
    </div>
  </div>
</div>
<div id="about-us" class="container-fluid fh5co-about-us pl-0 pr-0 parallax-window" data-parallax="scroll" data-image-src="images/bg3.png">
  <div class="container">
    ...
    <div class="row gallery">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <img class="card-img-top img-fluid wow bounceInRight" data-wow-delay=".25s" src="images/SERVbowling.png" alt="Card image"> </div>
      </div>
      <div class="col-md-4">
        <div class="card"> <img class="card-img-top img-fluid wow bounceInUp" data-wow-delay=".25s" src="images/bizhour.png" alt="Card image">
      ...
      <div class="col-md-4">
        <div class="card">
          ...
          <img class="card-img-top img-fluid wow bounceInLeft" data-wow-delay=".25s" src="images/snooker.png" alt="Card image"> </div>
      </div>
    </div>
  </div>
</div>
